...
/**
 * The MySiteName_Admin_Loader is a class that is responsible for coordinating all actions and filters used through the admin portion of the plugin.
 * 
